...
Rails.application.configure do
  ...
  config.action_cable.url = "wss://financeiro.gemsoftwarehouse.com.br/cable"
  config.action_cable.allowed_request_origins = [ "https://financeiro.gemsoftwarehouse.com.br" ]
